...
if has("autocmd")
  ...
  autocmd FileType c,cpp,java,php,ruby,python,verilog_systemverilog autocmd BufWritePre <buffer> :call <SID>StripTrailingWhitespaces()
...
:nmap ,r :set textwidth=120 <CR> gqap  " re-flow text to 78 columns
